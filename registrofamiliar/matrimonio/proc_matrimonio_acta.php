...
if($_POST["nom"] == "" and $_POST["accion"] != "guardar-matrimonio-acta"){
...
/* ==================================================================================================== *
 * ==================================================================================================== *
 * Definición de las funciones utilizadas en este script
 * ==================================================================================================== *
 * ==================================================================================================== */

/* ==================================================================================================== *
 * Función guardarMatrimonioPartida()
 * Guarda los datos del formulario principal "form_matrimonio_acta"
 * ==================================================================================================== */

function guardarMatrimonioActa(){
	...
	$consulta = "INSERT INTO rf_matrimonio_acta (ano_lib, num_lib, num_tom, num_pag, num_act, cod_eso, cod_esa, 
	nom_eso, ape1_eso, ape2_eso, nom_esa, ape1_esa, ape2_esa, fec_mat, cue, esc_lib) 
	VALUES ('$_POST[ano_lib]', '$_POST[num_lib]', '$_POST[num_tom]', '$_POST[num_pag]', '$_POST[num_act]', 
		$_POST[cod_eso], $_POST[cod_esa], '$_POST[nom_eso]', '$_POST[ape1_eso]', '$_POST[ape2_eso]', '$_POST[nom_esa]', 
		'$_POST[ape1_esa]', '$_POST[ape2_esa]', '$_POST[fec_mat]', '$_POST[cue]', '$_POST[esc_lib]')";
	if(pg_query($consulta))
	{
		pg_query("INSERT INTO se_bitacora(accion,id_usuario,fecha,hora) VALUES('Registró acta de matrimonio',".$_SESSION['ta02_cod'].",CURRENT_DATE,CURRENT_TIME)");
		echo 	"<script type='text/javascript'>" .
				"alert('Guardado exitosamente');" .
				"parent.location.href='../index_registrofamiliar.php';" .
				//"parent.centro.location.href='form_matrimonio_digestyc.php?num_lib=" . $_POST[num_lib] . "&num_par=" . $_POST[num_par] . "&cod_eso=" . $_POST[cod_eso] . "&cod_esa=" . $_POST[cod_esa] . "#'" .
				"</script>";
	}
	else
	{
