...
<html lang="es">
	<head>
		<meta charset="utf-8" >
		<title>Registro de Partidas de Divorcio</title>
	...
	<body>
		...
		<form class="well form-horizontal" name="form_divorcio_partida" id="form_divorcio_partida" action="" method="POST" >
			<fieldset>
				<legend>Registro de Partidas de Divorcio</legend>
				
				<input type="hidden" name="accion" value="guardar-divorcio-partida">
				<input type="hidden" value="" name="cod_eso" id="cod_eso">
				<input type="hidden" value="" name="cod_esa" id="cod_esa">
				...
				<div class="row">
					<div class="control-group span6">
						<label class="control-label" for="nom_eso">Nombre del ex-esposo (*)</label>
						<div class="controls">
					...
					<div class="control-group span6">
						<label class="control-label" for="nom_esa">Nombre de la ex-esposa (*)</label>
						<div class="controls">
				...
				<div class="row">
					<div class="control-group span6">
						<label class="control-label" for="ape1_eso">Primer apellido del ex-esposo (*)</label>
						<div class="controls">
					...
					<div class="control-group span6">
						<label class="control-label" for="ape1_esa">Primer apellido de la ex-esposa (*)</label>
						<div class="controls">
				...
				<div class="row">
					<div class="control-group span6">
						<label class="control-label" for="ape2_eso">Segundo apellido del ex-esposo</label>
						<div class="controls">
					...
					<div class="control-group span6">
						<label class="control-label" for="ape2_esa">Segundo apellido de la ex-esposa</label>
						<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="fec_div">Fecha del divorcio (*)</label>
					<div class="controls">
						<input type="date" min="1961-01-01" max="<?php echo date('Y-m-d'); ?>" name="fec_div" id="fec_div" tabindex="12">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="input-xxlarge" rows="14" name="cue" id="cue" tabindex="13"></textarea>
					</div>
				</div>
		...
		<script type="text/javascript" >
			...
			$(document).ready(function(){
				...
				$("#btn-guardar").click(function(){
					if(validarVacios()){
			   			if(confirm("¿Esta seguro de querer guardar estos datos?")){
			   				$.ajax({
			          			type: "POST",
			           			url: "proc_divorcio_partida.php",
			           			data: $("#form_divorcio_partida").serialize(),
				...
				$("#esc_libx").change(function(){
					...
					$("#esc_lib").attr({value : "div_par_" + num_lib + "_" + num_par + ".jpg" });
					
					$.ajax({
						type : "POST",
						url : "../img/proc_subir_imagen.php",
						data : new FormData($("#form_divorcio_partida")[0]),
						cache : false,
						contentType : false,
						processData : false
					});
			...
			/* Termina funcion para validar vacios */
