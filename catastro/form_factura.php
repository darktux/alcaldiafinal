...
<html lang="es">
	...
	<body>
		...
		<form action="" class="well form-horizontal">
			...
			<input type="hidden" name="cod_con" id="cod_con" value="<?php echo $_GET['cod_pro']; ?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xlarge" name="nom_con" id="nom_con" value="<?php echo $_GET['propietario']; ?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-prepend">
						...
						<input type="number" name="mon_det" id="mon_det" class="span2" step="0.01" min="0.01" max="1000" value="<?php echo $_GET['total']; ?>">
					</div>
				</div>
			</div>
