<?php 
	...
	$PHPJasperXML->arrayParameter=array("idcon"=>$id,"idneg"=>$idneg,"fechaReporte"=>$fecha,"horaReporte"=>$hora,"mesPagado"=>$mesPagado,"numRec"=>$numRec,"fecRec"=>$fec_rec,"nuePro"=>$nuePro,"proAct"=>$proAct);
	if($tip_con=="N")
		$archivo="../reportes/catastro/form_traspaso.jrxml";
	else
		$archivo="../reportes/catastro/form_traspaso_jur.jrxml";
