...
<head>
	...
	<script src="js/act_proyecto.js"></script>
</head>

<!-- <body style="background-color: rgba(255,255,255,0.60);"> -->
<body>
	<div name="form_proyecto" id="form_proyecto" class="well form-horizontal">
		<legend>Actualizar Datos de Proyecto</legend>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="1">
					...
					<div class="control-group span10">
						...
						<div class="controls" style="margin-left:100px;">
							<label class="radio inline"><input type="radio" name="tip_fon" id="tip_fon_p" value="Propios"  onchange="mostrarTipoMonto()">Propios</label>
							<label class="radio inline"><input type="radio" name="tip_fon" id="tip_fon_e" value="Externos" checked onchange="mostrarTipoMonto()">Externos</label>
							<label class="radio inline"><input type="radio" name="tip_fon" id="tip_fon_c" value="Combinados" onchange="mostrarTipoMonto()">Mixtos</label>
						</div>
					</div>
				...
				<div class="tab-pane" id="2">
					...
					<br><br> 
					<input type="hidden" id="cod_col" value="0">
					...
					<div class="control-group span10" id="divAnadir">
						<div class="controls">
							<a href="#" class="btn offset1	" id="addCol" onclick="addColaborador()"><i class="icon-plus"></i> Añadir</a>
						</div>
					</div>
	...
	<div class="modal hide fade" id="bus_per2">
		...
		<div class="modal-footer">
			<a href="#" class="btn" data-dismiss="modal" onclick="vermsj2()"><i class="icon-remove"></i> Cancelar</a>
		</div>
	</div>
