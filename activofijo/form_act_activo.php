...
<head>
	...
	<script src="form_act_activo.js"></script>
</head>
<body onload="cargar_sel()">
	<form action="proc_nuevo_activo.php" method="post" class="well form-horizontal span12" id="form_nuevo_activo" name="form_nuevo_activo" >
			<legend align="center">Actualizar Activo</legend>
		...
		<div class="row">
			...
			<div class="control-group span6">
				...
				<div class="controls">
					<label class='radio'><input type='radio' name='ori' id='ori_d' onChange="ocultar()" value='donado' checked>Donado</label>
		  			<label class='radio'><input type='radio' name='ori' id='ori_c' onChange="ocultar()" value='comprado'>Comprado</label>
				</div>
			</div>
		...
		<div class="row">
			<div class="form-actions span6 offset2">
				<button type="button" class="btn" name="actualizar" id="actulizar"><i class="icon-refresh"></i> Actualizar</button>			
