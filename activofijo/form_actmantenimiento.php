...
<html lang='es'>
	<head>
		...
		<script src="form_actmantenimiento.js"></script>
	</head>
	<body>
			<form action="proc_nuevo_mantenimiento.php" method="post" id="form_mantenimiento" class="well form-horizontal span12">
				<legend>Actualizar Reparación</legend>

				<input type="hidden" id="cod_man" name="cod_man">

				<a href="#bus_act" data-toggle="modal" class="btn"><i class="icon-search"></i>Buscar Reparación</a><br><br><br>
		...
		<div class="row">
			<div class="form-actions span6 offset2">
				<button type="button" class="btn" name="actualizar" id="actualizar"><i class="icon-refresh"></i> Actualizar</button>			
